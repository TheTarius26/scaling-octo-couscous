...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i17.ProductLocalStorage>(() => _i17.ProductLocalStorage());
    ...
    gh.factory<_i595.DetailProductBloc>(
        () => _i595.DetailProductBloc(gh<_i1010.GetProductByIdUsecase>()));
    gh.factory<_i17.HomeBloc>(() => _i17.HomeBloc(
          gh<_i331.GetProductsUsecase>(),
          gh<_i118.DeleteProductUsecase>(),
          gh<_i17.ProductLocalStorage>(),
        ));
    return this;
  }
}
